...
Essa é uma plataforma de kanban simples. Com esse projeto, foram praticados diversos conceitos do ReactJS e ferramentas, como:
* Estados (State)
* Contexto (Context API)
* Estilização com TailwindCSS
* A lib react-beautiful-dnd

## :books: Funcionalidades
:heavy_check_mark: **Reorganizar as tarefas de uma coluna**

:heavy_check_mark: **Mover uma tarefa de uma coluna para outra**
...
> Deploy da aplicação em <https://kanbangk.vercel.app>
